...
<head>
    ...
    <style>
        body {
            ...
            background-color: #121212; /* Nền đen chính */
        }
        .text-primary {
        --tw-text-opacity: 1;
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <aside class="lg:col-span-1 bg-gray-900/70 p-6 rounded-lg self-start">
                <div class="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                        <h2 class="font-bold text-lg text-white">duong van thai bao</h2>
                ...
                <nav class="space-y-2">
                    <a href="#" class="flex items-center p-3 rounded-lg bg-red-600 text-white font-bold">
                ...
                <div class="bg-gray-900 p-8 rounded-lg shadow-xl mb-8">
                    ...
                    <form class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="fullName" value="duong van thai bao" class="mt-1 block w-full bg-gray-800 border-gray-600 text-white rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="dob" class="block text-sm font-medium text-gray-400">Ngày lập tài khoản</label>
                            <input type="date" id="dob" value="2006-01-25" class="mt-1 block w-full bg-gray-800 border-gray-600 text-white rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                        </div>
                         <div>
                            <label for="email" class="block text-sm font-medium text-gray-400">Email</label>
                            <input type="email" id="email" value="thaibao250306@gmail.com" class="mt-1 block w-full bg-gray-800 border-gray-600 text-white rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                        </div>
                ...
                <div class="bg-gray-900 p-8 rounded-lg shadow-xl">
                    ...
                    <form class="space-y-6">
                        <div>
                            ...
                            <input type="password" id="oldPassword" class="mt-1 block w-full bg-gray-800 border-gray-600 text-white rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="newPassword" class="block text-sm font-medium text-gray-400">Mật khẩu mới *</label>
                            <input type="password" id="newPassword" class="mt-1 block w-full bg-gray-800 border-gray-600 text-white rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="confirmPassword" class="block text-sm font-medium text-gray-400">Xác thực mật khẩu *</label>
                            <input type="password" id="confirmPassword" class="mt-1 block w-full bg-gray-800 border-gray-600 text-white rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                        </div>
                        <div>
